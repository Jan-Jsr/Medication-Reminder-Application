...
app.secret_key = 'Tswhy/569'


# Configure database connection
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:Tswhy/569@localhost/medication_reminder'
...
def add_reminder(entry_id):
    ...
    medication_entry = MedicationEntry.query.get(entry_id)
